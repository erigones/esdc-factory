...
* **org.erigones:cfgdb_zk_rest_ssl_cert**: SSL certificate for the ZK REST service.
* **org.erigones:cfgdb_zk_rest_ssl_key**: SSL private key for the ZK REST service. The ZK REST service is enabled only if the key and the certificate are both provided.
